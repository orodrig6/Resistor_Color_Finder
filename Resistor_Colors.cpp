...
long long int color_band(long long int x) {
	...
	third_digit = (long long)str_num[2]-48; //third digit (from left to right) is used to determine if we round up or not
...
int main(int argc, char* argv[]) {
	...
	cin >> num;
	while (num > 99000000000 || num < 0) { // checks if the user entered a resistance within range
