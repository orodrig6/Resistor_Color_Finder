...
int main(int argc, char* argv[]) {
	...
	cout << "Give me a number between 0 and 99E9" << endl;
	cin >> num;
	while (num > 99000000000 || num < 0) {
		cout << "Number is out of desired range" << endl;
		cout << "Please enter a number between 1 and 99E9" << endl;
		cin >> num;
	}
	cout << "Finished successfully, your number is:" << num << endl;
